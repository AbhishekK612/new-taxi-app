...
<%
    response.sendRedirect(request.getContextPath() + "/new/services.jsp");
    return;
%>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-7">
                    ...
                    <div class="hero-cta d-flex flex-wrap">
                        <a href="${pageContext.request.contextPath}/book-ride.jsp" class="btn btn-primary-custom">Book a Ride</a>
                        <a href="${pageContext.request.contextPath}/contact.jsp" class="btn btn-outline-custom">Contact Support</a>
                    </div>
                </div>
                <div class="col-lg-5">
